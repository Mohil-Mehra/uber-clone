...
const usersignup = () => {
  ...
  <div className='flex gap-4 mb-5'>
    <input required type="text"   className='bg-[#eeee] rounded px-4 py-2 border w-full text-lg placeholder:text-base ' placeholder="First name" />
    <input required type="text"   className='bg-[#eeee] rounded px-4 py-2 border w-full text-lg placeholder:text-base ' placeholder="Last name"/>
  </div>
   <h3 className='text-xl mb-2'>What's your email?</h3>
    ...
    <input required type="password"  className='bg-[#eeee] rounded px-4 py-2 border mb-5 w-full text-lg placeholder:text-base ' placeholder="Password" />
   ...
   <p className='text-sm mb-5 mt-1'>Already have a account? <Link to="/userlogin" className='text-blue-500 '>Login here </Link>  </p>
   </form>
